...
public class UserService {
	...
	public void registerNewUser(String id, String password, String name) {
		...
		for (int i = 0; i < Database.USERS_DB.size(); i++) {
			if (Database.USERS_DB.get(i).getId().equals(id) && Database.USERS_DB.get(i).getId().equals(password)) {
	...
	public void showRegisteredCourseToUser(User user) {
		// assigning the result of user.getRegisteredCourses() to the registeredCourses variable.
		//This line creates a new ArrayList and makes registeredCourses refer to this newly created list
